...
class HbbTVDriver extends BaseDriver {
     ...
     */
    async reset () {
        this.implicitWaitMs = IMPLICIT_WAIT_TIMEOUT
    }
    ...
    async start (caps, sessionId) {
        ...
        /**
         * open app if defined in capabilities
         */
        if (typeof caps.app === 'string') {
            commands.setUrl.call(this, caps.app)
        }
    ...
    async startEmulator () {
        ...
        await this.emulator.sendCmd('open', { url: 'http://google.com' })
    }
}
