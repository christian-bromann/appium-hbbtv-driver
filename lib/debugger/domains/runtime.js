...
import {
    getConsoleArg, __getStacktrace, getFakeError, getObjectProperties,
    getScopeObject
} from '../utils/runtime'
 ...
 */
export function compileScript ({ expression }) {
    const script = {
        expression,
...
export function evaluate ({
    ...
    if (objectGroup === 'completion') {
        return getScopeObject(expression)
    }
 ...
 * @return {ExceptionDetails}                     exception details
 */
export function callFunctionOn ({ arguments: args, functionDeclaration }) {
