...
import { hasGzipEncoding, getIpAddress, readConfig, writeConfig, getDescription, getDeviceInformation } from './utils'
    ...
    async getNodeConfig (req, res) {
        ...
        return res.json({
            ...
            configuration: {
                ...
                url: `http://${this.piIPAddress}:4723/wd/hub`,
                host: this.piIPAddres,
                port: 4723,
                maxSession: 1,
                register: true,
                registerCycle: 5000
