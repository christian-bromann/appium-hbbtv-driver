...
import { DebuggerService, DriverService } from './services'
...
export default class Proxy {
    constructor (port = 8080) {
         ...
         * initialise services
         */
        this.driver = new DriverService(this.io)
    ...
    handleResponse (res, proxyRes) {
        ...
        content = content.replace('</body>',
            Proxy.inject(DriverService.name, DriverService.getScript()) + '</body>')
        content = content.replace('</body>',
            Proxy.inject(DebuggerService.name, DebuggerService.getScript()) + '</body>')
